...
systemWidth   = 500 # x-axis (nm)
systemLength  = 500 # y-axis (nm)
systemHeight  = 500 # z-axis (nm)
...
TFnumberInit = 100 # This is the number of TF molecules at system start
